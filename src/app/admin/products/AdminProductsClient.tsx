...
const SIZES = ['44', '46', '48', '50', '52', '54', 'XS', 'S', 'M', 'L', 'XL', 'One Size'];
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleSubmit}>
          ...
          <Form.Item name="colors" label="Цвета">
            <Select mode="multiple" options={COLORS.map((c) => ({ value: c, label: c }))} />
          </Form.Item>
          ...
          <Form.Item name="images" label="Ссылки на фото (по одной на строку)">
