...
export async function generateMetadata({ params }: Props) {
  ...
  return { title: lang === 'ru' ? 'Аксессуары — MVXIII' : 'Accessories — MVXIII' }
}
...
export default async function AccessoriesPage({ params, searchParams }: Props) {
  ...
  return <CatalogPage lang={lang} dict={dict} categorySlug="accessories" title={lang === 'ru' ? 'Аксессуары' : 'Accessories'} searchParams={sp} />
}
