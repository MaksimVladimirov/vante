...
export async function generateMetadata({ params }: Props) {
  ...
  return { title: lang === 'ru' ? 'Брюки — MVXIII' : 'Trousers — MVXIII' }
}
...
export default async function PantsPage({ params, searchParams }: Props) {
  ...
  return <CatalogPage lang={lang} dict={dict} categorySlug="pants" title={lang === 'ru' ? 'Брюки' : 'Trousers'} searchParams={sp} />
}
